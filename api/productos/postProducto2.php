<?php
//este post guarda el nombre de la imagen en la base de datos
...
if (in_array($tipoImagen, ["jpg", "jpeg", "png"])) {
    ...
    $nombreArchivo = $idRegistro . "." . $tipoImagen; // Nombre del archivo sin ruta
    $ruta = $directorio . $nombreArchivo; // Ruta completa para mover el archivo
    ...
    if (move_uploaded_file($miniatura["tmp_name"], $ruta)) {
        ...
        $stmt->bind_param("ssdddiss", $nombre, $categoria, $precio, $descuento, $rating, $stock, $marca, $nombreArchivo);
